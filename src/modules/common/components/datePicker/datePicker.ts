let popupTemplate = require('ngtemplate!./template/datepicker/popup.html');
let datePickerTemplate = require('ngtemplate!./template/datepicker/datepicker.html');
 ...
 */
require('!ngtemplate?relativeTo=/src/modules/common/components/datePicker/template/datepicker/!html!./template/datepicker/day.html');
require('!ngtemplate?relativeTo=/src/modules/common/components/datePicker/template/datepicker/!html!./template/datepicker/month.html');
require('!ngtemplate?relativeTo=/src/modules/common/components/datePicker/template/datepicker/!html!./template/datepicker/year.html');
...
export class DatePicker implements ng.IComponentOptions {
    ...
    constructor() {
        this.templateUrl = require('ngtemplate!./datePicker.html');
