...
import { ValidationProcessor } from 'modules/common/utils/validationProcessor';
...
export abstract class BaseEditorController<T> implements IValidatableController {
    ...
    constructor(
        ...
        this.rulesCustomizer = this.validator().rulesCustomizer;
     ...
     */
    public abstract validator(): IValidator;
